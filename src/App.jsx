          ...
          <div className="w-full h-screen flex items-center justify-center bg-black">
            <div className="cntnr flex text-white w-full h-[80%] ">
              ...
              <div className="rg w-[30%] py-30">
                ...
                <button className="bg-yellow-500 px-10 py-10 text-black mt-10 text-4xl mb-10 absolute right-148 top-369 rounded-lg hover:bg-yellow-400 transition-all duration-300">
                  Download Now
                </button>
              </div>
            </div>
